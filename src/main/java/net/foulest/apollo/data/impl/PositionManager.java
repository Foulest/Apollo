...
import net.foulest.apollo.check.type.PositionCheck;
...
import net.foulest.apollo.data.BoundingBox;
...
public final class PositionManager {
    ...
    public synchronized void handle(World world, double posX, double posY, double posZ, boolean onGround) {
        ...
        if (Arrays.stream(entities).anyMatch(entity -> entity instanceof Vehicle)) {
            return;
        }
