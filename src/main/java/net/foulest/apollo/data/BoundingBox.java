...
public final class BoundingBox {
    ...
    public double distance(Location location) {
        return Math.sqrt(Math.min(Math.pow(location.getX() - minX, 2),
                Math.pow(location.getX() - maxX, 2)) + Math.min(Math.pow(location.getZ() - minZ, 2),
                Math.pow(location.getZ() - maxZ, 2)));
    }
